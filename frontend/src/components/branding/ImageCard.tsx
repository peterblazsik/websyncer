      ...
      <div className="relative" style={aspectRatioStyle}>
        {hasImage ? (
          <>
            ...
            <button
              onClick={() => setLightboxOpen(true)}
              className="absolute top-2 left-2 p-1.5 rounded-lg bg-black/60 text-white/80 hover:bg-black/80 hover:text-white opacity-0 group-hover:opacity-100 transition-opacity"
        ...
        {/* Generating overlay with skeleton pulse */}
        {isGenerating && (
